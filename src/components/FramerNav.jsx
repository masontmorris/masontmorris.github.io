...
function FramerNav() {
    ...
    return (
        <div className="App">
            <Header>
                <SvgBox variants={iconVariants} animate={isOpen ? "opened" : "closed"} whileHover={{ scale: 1.4 }} onClick={() => setIsOpen(!isOpen)}>
            ...
            <Nav initial={false} variants={menuVariants} animate={isOpen ? "opened" : "closed"}>
